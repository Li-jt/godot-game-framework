...
## 默认为 true，游戏层按需覆写。
func on_drop(_event: GF_UIDragEvent) -> bool:
	return true
...
func on_end_drag(_event: GF_UIDragEvent) -> void:
	pass
