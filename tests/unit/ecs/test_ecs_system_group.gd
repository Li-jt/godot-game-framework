...
var _world: EcsWorld
var _group: EcsSystemGroup


func before_each() -> void:
	_world = EcsWorld.new()
	_group = EcsSystemGroup.new("TestGroup")
...
func test_remove_by_name() -> void:
	var desc := EcsSystemDescriptor.new()
...
func _make_system(p_tick_fn: Callable) -> EcsSystem:
	var s := GDScript.new()
	s.source_code = """
extends EcsSystem
var _tick_fn
