...
func before_each() -> void:
	...
	_panel.ctx.config = GF_AppConfig.new()
	add_child(_panel)
...
func test_focus_all_sets_children_to_focus_all() -> void:
	_panel.ctx.config.ui.focus_navigation.default_mode = Control.FOCUS_ALL
...
func test_focus_click_sets_children_to_focus_click() -> void:
	_panel.ctx.config.ui.focus_navigation.default_mode = Control.FOCUS_CLICK
...
func test_focus_none_leaves_children_unchanged_or_none() -> void:
	_panel.ctx.config.ui.focus_navigation.default_mode = Control.FOCUS_NONE
