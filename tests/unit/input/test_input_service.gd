...
var _service: InputService


func before_each() -> void:
	_service = InputService.new()
...
func test_register_action_def_adds_to_resolver() -> void:
	var def := InputActionDef.new("jump")
...
func test_get_action_def_returns_correct() -> void:
	var def := InputActionDef.new("move_left")
	_service.register_action_def(def)
...
func test_get_all_action_ids_returns_all() -> void:
	_service.register_action_def(InputActionDef.new("jump"))
	_service.register_action_def(InputActionDef.new("move_left"))
	var ids := _service.get_all_action_ids()
	assert_eq(ids.size(), 2)


func test_read_axis_default_zero() -> void:
	_service.register_action_def(InputActionDef.new("move_right"))
