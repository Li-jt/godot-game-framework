...
var _cue_defs: Dictionary = {}          # id -> GF_AudioCueDef
...
func stop(p_channel: GF_AudioRuntime.Channel) -> void:
	_runtime.stop(p_channel)


func stop_bgm() -> void:
	_runtime.stop(GF_AudioRuntime.Channel.BGM)


func set_volume(p_channel: GF_AudioRuntime.Channel, p_volume: float) -> void:
	_runtime.set_volume(p_channel, p_volume)


func get_volume(p_channel: GF_AudioRuntime.Channel) -> float:
	return _runtime.get_volume(p_channel)


func mute(p_channel: GF_AudioRuntime.Channel) -> void:
	_runtime.mute(p_channel)


func unmute(p_channel: GF_AudioRuntime.Channel) -> void:
	_runtime.unmute(p_channel)


func is_muted(p_channel: GF_AudioRuntime.Channel) -> bool:
